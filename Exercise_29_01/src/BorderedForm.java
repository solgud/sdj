...
public class BorderedForm extends JFrame
{
   ...
   public BorderedForm()
   {
      ...
      formsPanel.setLayout(new GridLayout(7,1,5,5));
      ...
      // Give a pleasing border to the forms panel
      formsPanel.setBorder(BorderFactory.createEmptyBorder(5, 10, 20, 20));
